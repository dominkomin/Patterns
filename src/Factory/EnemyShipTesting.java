...
public class EnemyShipTesting
{
	...
	public static void main(String[] args)
	{
		 ...
		 * EnemyShip theEnemy = null;
		 * 
		 * // Old way of creating objects // When we use new we are not being
		 * dynamic
		 * 
		 ...
		 * // -----------------------------------------
		 * 
		 * // This allows me to make the program more dynamic // It doesn't
		 * close the code from being modified // and that is bad!
		 * 
