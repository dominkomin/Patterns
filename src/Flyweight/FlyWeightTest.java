...
public class FlyWeightTest extends JFrame
{
	...
	Color[] shapeColor =
	{ Color.orange, Color.red, Color.yellow, Color.blue, Color.pink,
		...
		startDrawing.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent event)
			{
				...
				for (int i = 0; i < 100000; ++i)
				{
					...
					//
					/*
					 * MyRect rect = new MyRect(getRandColor(), getRandX(),
					 * getRandY(), getRandX(), getRandY()); rect.draw(g);
					 */

					//
					/*
					 * g.setColor(getRandColor()); g.fillRect(getRandX(),
					 * getRandY(), getRandX(), getRandY());
					 */
